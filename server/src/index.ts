...
const timeToAddEventToDb: number = 14400000;
...
const saveEventData = async (eventData: EventDataIn) => {
  try {
    const objToSave = {
    ...
    await axios.post("http://localhost:3002/events", objToSave);
